      ...
      <div className="Footer">
        <div className="upper-footer">
          <div className="left-upper-footer">
            {/* <img src={logoFooter} /> */}
            <span className="logo-footer">ABDUL - REHMAN</span>
            <p>
              This is a portfolio made by <span>Abdul-Rehman</span> using React
              with Parcel.
            </p>
        ...
        <div className="lower-footer">
          <p>
            Copyright <i className="ri-copyright-line"></i> Abdul Rehman 2025
          </p>
        </div>
      </div>
    </>
